...
class DeepPiCar(object):
    ...
    def __init__(self):
        ...
        self.camera = cv2.VideoCapture(0)       #modified port to suit picar-x
        self.camera.set(3, self.__SCREEN_WIDTH)
        self.camera.set(4, self.__SCREEN_HEIGHT)

        #Camera pan and tilt servo setup as per picar - Not requrired
        ''' 
        ...
        # Back and Front wheel setup as per picar - Not required
        '''
    ...
    def cleanup(self):
        ...
        # Setup as per picar-x
        self.pibot.forward(0)
        self.pibot.set_dir_servo_angle(0)
        '''
